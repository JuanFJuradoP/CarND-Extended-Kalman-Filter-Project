...
def plot_kalman_graph(kalman_file_path, save_file=None):
    # Initialize Variables for save Kalman info
    ground_truth_x = []
    ground_truth_y = []
    ground_truth_vx = [] 
    ground_truth_vy = [] 
    ...
    # Create a sub plot to show the car info
